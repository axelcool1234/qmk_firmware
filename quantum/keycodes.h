...
// Alias
    ...
    QK_SREP    = QK_SKIP_ALT_REPEAT_KEY,
};
...
#define IS_QUANTUM_KEYCODE(code) ((code) >= QK_BOOTLOADER && (code) <= QK_SKIP_ALT_REPEAT_KEY)
...
#define QUANTUM_KEYCODE_RANGE               QK_BOOTLOADER ... QK_SKIP_ALT_REPEAT_KEY
